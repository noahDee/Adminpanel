...
student1 = Student.new(first_name: "Noah", last_name: "Dee", email: "example@example.com", password: "1234", enrolled: true, education: "hs", age: 23)
...
cohort1.course.name = course1.name
